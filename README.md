...
![在这里插入图片描述](https://img-blog.csdnimg.cn/861955708b1b4e269703779bd85a877c.png)
...
${KAFKA_HOME}/bin/kafka-topics.sh --bootstrap-server kafka-node1:9092,kafka-node2:9092,kafka-node3:9092 --describe
```
![在这里插入图片描述](https://img-blog.csdnimg.cn/afd9833ae49e4f3399c963232c825428.png)
### 5）删除topic
...
![输入图片说明](https://foruda.gitee.com/images/1684664567193015805/c746d693_1350539.png "屏幕截图")